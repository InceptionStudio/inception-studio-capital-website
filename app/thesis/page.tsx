          ...
          <Container>
            ...
            <div className="mt-6 grid lg:grid-cols-2 gap-10">
              <div className="space-y-4 text-neutral-300 leading-relaxed">
                ...
                <p><strong>Barbell deployment.</strong> ~$100k starters across ~40 companies at formation; $500k–$1.5M core positions into ~12 with traction. Target 20–30% fund into breakouts.</p>
