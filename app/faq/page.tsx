...
export default function Page(){
  const items = [
    ...
    {q:'How do you deploy capital?', a:'Barbell strategy: ~$100k starter checks in ~40 companies at incorporation (1–2% target ownership), then $500k–$1.5M core positions in ~12 companies with strong traction (2.5–10% ownership). We secure MFN and pro‑rata rights on every investment to follow our winners.'},
