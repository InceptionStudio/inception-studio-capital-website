...
function Highlight({
  ...
  return (
    <div>
      ...
      <ul className="space-y-2 list-disc pl-5 text-neutral-300 text-sm">
        {items.map(item => (
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  <div className="aspect-square rounded-2xl bg-white/5 ring-1 ring-white/10 overflow-hidden relative">
                    <Image
                  ...
                  <div>
                    ...
                    <p className="text-lg text-brand-400 mb-4">Co-Founder &amp; Managing Partner</p>
                    <ContactLinks
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-6 text-neutral-300">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">Inception Studio</h3>
                      <p className="leading-relaxed text-sm">
